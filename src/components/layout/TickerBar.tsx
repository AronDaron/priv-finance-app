...
function buildItems(data: GlobalMarketData): TickerItem[] {
  ...
  return [
    ...
    { label: 'WTI',     price: c.oil.price,       changePercent: c.oil.changePercent,       decimals: 2, unit: 'USD/bbl' },
    { label: 'Brent',   price: c.brent.price,     changePercent: c.brent.changePercent,     decimals: 2, unit: 'USD/bbl' },
