...
const COMPONENT_META: Record<string, { desc: string; rawUnit?: string; rawLabel?: string }> = {
  ...
  'US10Y Yield':           { desc: 'Rentowność 10-letnich obligacji rządu USA. Powyżej 4–5% oznacza zacieśnienie finansowe — droższa pożyczka dla firm i rządów. Wpływa negatywnie na wyceny akcji globalnie.', rawUnit: '%', rawLabel: 'Rentowność' },
  ...
  'Ropa Brent (import)':   { desc: 'Zmiana ceny ropy Brent (BZ=F) w ciągu 30 dni. Europa i Azja rozliczają się wg benchmarku Brent — wzrost cen zwiększa koszty energii, inflację i ciąży na marżach firm.', rawUnit: '%', rawLabel: 'Zmiana 30d' },
  ...
  'JPY+CNY (kurs)':        { desc: 'Średnia dzienna zmiana koszyka walut azjatyckich (jen japoński, juan chiński) vs USD. Umocnienie = silniejszy region, więcej kapitału napływa do Azji.', rawUnit: '%', rawLabel: 'Zmiana koszyka dziś' },
  'Miedź (przemysł)':      { desc: 'Zmiana ceny miedzi w ciągu 30 dni. Azja (głównie Chiny) to największy konsument miedzi — rosnące ceny sygnalizują silny popyt przemysłowy i ożywienie gospodarcze.', rawUnit: '%', rawLabel: 'Zmiana 30d' },
  ...
  'Ropa WTI+Brent (30 dni)': { desc: 'Średnia zmiana ceny ropy WTI (CL=F) i Brent (BZ=F) w ciągu 30 dni. Połączenie obu benchmarków daje pełniejszy obraz globalnego rynku ropy naftowej.', rawUnit: '%', rawLabel: 'Zmiana 30d (śr.)' },
